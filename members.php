...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2" style="margin-bottom: 15px;">
                                <a href="#" class="btn btn-primary" type="button" data-toggle="modal"
                                    data-target="#loginModal">KCB Member Login</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form-horizontal" id="frmLogin" name="frmLogin">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" name="codeType" id="radioText" value="text"
                                                checked="">
                                            Text Code
                                        </label>
                                    </div>
                                    <div class="radio-inline">
                                        <label>
                                            <input type="radio" name="codeType" id="radioEmail" value="email">
                                            Email Code
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group" id="div_auth" style="display:none;">
                                <label for="auth_cd" class="col-lg-3 control-label">Additional Authentication
                                    Required</label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" id="auth_cd" placeholder="Login Code"
                                        maxlength="6">
                                    <input type="checkbox" id="auth_remember" checked="checked"> Remember me (do not use
                                    on public computers)
                                    <p class="help-block">This is the first time this account is being accessed from
                                        this computer (or your
                                        cookies have been deleted since the last time you logged in.) You have received
                                        a text or email with a 6-digit code.
                            ...
                            <div class="form-group">
                                <label for="fb" class="col-lg-3 control-label"></label>
                                <div class="col-lg-9">
                                    <div id="fb" class="fb-login-button" data-width="" data-size="medium"
    ...
    <script src="kcb-js/memberlogin-20210926.js"></script>
</body>
